...
| [`03-PINN-Estimation.ipynb`](https://colab.research.google.com/drive/1LCZ345Gx9bCQFPe73BuPorTkZKxBsSOA) | Physics‑Informed Neural Network (PINN) implementation in PyTorch. The network learns the displacement while respecting the governing ODE. Training includes the physics loss, and the final estimates of $\gamma$ and $\omega_0$ are extracted. |
...
| **02 – Bayesian Estimation** | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/drive/1ZDlHRoDN1_yvvaPJIKafEYG77uilO1Kp) |
| **03 – PINN Estimation** | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/drive/1LCZ345Gx9bCQFPe73BuPorTkZKxBsSOA) |
